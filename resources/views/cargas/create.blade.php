  ...
  <tbody>
    ...
    <tr>
        ...
        <td colspan="3" style="text-align:right;">
            ...
            <!--
            <button type="button" onClick="objetosPrueba()" class="btn btn-success btn-lg ">
                <i class="fas fa-check"></i> 
                    objetos
            </button>
            <button type="button" onClick="objetosAllPrueba()" class="btn btn-success btn-lg ">
                <i class="fas fa-check"></i> 
                    allProducts
            </button>
            -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">DATOS DE LA CARGA</h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onClick="guardarCarga()">Confirmar</button>
...
var allProductsStatic = JSON.parse(document.getElementById('objProductosStatic').value)
    ...
    if(allProductsStatic.length > countSelect)
    {
        ...
        var html = "";
            ...
            html +='</tr>'
        $('#tablaProductos tr').eq(-2).before(html);
